        ...
        <div className="mt-6 w-full text-left">
          <div className="mb-2.5 flex items-center justify-between px-0.5">
            ...
            <button
              ...
              className="grid h-6 w-6 place-items-center rounded-md text-ink-faint transition-colors hover:bg-[var(--hover-subtle)] hover:text-ink-muted"
            >
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            {suggestions.map((s) => (
              <button
                ...
                className="flex min-h-[88px] flex-col items-start rounded-2xl bg-suggestion px-3.5 py-3.5 text-left transition-colors hover:bg-suggestion-hover"
              >
